...
SUBROUTINE GPSTRESS(YDGEOMETRY,YDGMV,YDDPHY,YDRIP,YDDYN,LDGRADSP,PGMV,PGMVS,POUT,PEXTRA)
! GPSTRESS 
!
! Externals
! ---------
...
DO JKGLO=1,NGPTOT,NPROMA
  ...
  CALL GPCTY(YDVFE,YDCVER,NPROMA,IST,ICEND,NFLEVG,.FALSE.,YDVAB,YDVETA,&
