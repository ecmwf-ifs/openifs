...
REAL(KIND=JPRB) :: ZPU0, ZPV0, ZFAC

REAL(KIND=JPRB),PARAMETER :: ZEPS1=100._JPRB*EPSILON(1._JPRB)
...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV,YDGEM=>YDGEOMETRY%YRGEM, &
 ...
 & YDCSGEOM=>YDGEOMETRY%YRCSGEOM(KIBL), YDGSGEOM=>YDGEOMETRY%YRGSGEOM(KIBL), &
  & YDSPGEOM=>YDGEOMETRY%YSPGEOM, YDDYN=>YDML_DYN%YRDYN,YDDYNA=>YDML_DYN%YRDYNA, &
  ...
  ELSE
    ...
    DO JLEV=1,NFLEVG
      ...
      DO JROF=KST,KPROF
        ...
        IF(LSLDP_CURV.AND.YDDYNA%LELTRA) THEN
          ...
          ZFAC=PUF(JROF,JLEV)*PUF(JROF,JLEV)+PVF(JROF,JLEV)*PVF(JROF,JLEV) &
           &  +ZZF(JROF,JLEV)*ZZF(JROF,JLEV)
          IF ((ZFAC > ZEPS1).AND.LSLDP_CURV_FIX) THEN
            ZFAC=SQRT(ZFAC/MAX(ZEPS1,(ZPU*ZPU+ZPV*ZPV)))
            ZPU=ZFAC*ZPU
            ZPV=ZFAC*ZPV
          ENDIF
        ELSEIF(YDDYNA%LELTRA) THEN
