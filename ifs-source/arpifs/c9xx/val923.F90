...
ASSOCIATE(NTPDES=>YRCLI%NTPDES, NTPGLA=>YRCLI%NTPGLA, NTPLAC=>YRCLI%NTPLAC, NTPMER=>YRCLI%NTPMER, &
 & SALBB=>YRCLI%SALBB, SALBD=>YRCLI%SALBD, SALBG=>YRCLI%SALBG, SALBM=>YRCLI%SALBM, &
 & SALBN=>YRCLI%SALBN, SALBX=>YRCLI%SALBX, SARGD=>YRCLI%SARGD, SARGN=>YRCLI%SARGN, &
 & SARGX=>YRCLI%SARGX, SDEPD=>YRCLI%SDEPD, SDEPN=>YRCLI%SDEPN, SDEPX=>YRCLI%SDEPX, &
 & SEMIB=>YRCLI%SEMIB, SEMID=>YRCLI%SEMID, SEMIG=>YRCLI%SEMIG, SEMIM=>YRCLI%SEMIM, &
 & SEMIN=>YRCLI%SEMIN, SEMIX=>YRCLI%SEMIX, SMANQ=>YRCLI%SMANQ, SMASK=>YRCLI%SMASK, &
 & SRSMD=>YRCLI%SRSMD, SRSMN=>YRCLI%SRSMN, SRSMX=>YRCLI%SRSMX, SSABD=>YRCLI%SSABD, &
 & SSABN=>YRCLI%SSABN, SSABX=>YRCLI%SSABX, STHER=>YRCLI%STHER, SZZ0B=>YRCLI%SZZ0B, &
 & SZZ0D=>YRCLI%SZZ0D, SZZ0M=>YRCLI%SZZ0M, SZZ0N=>YRCLI%SZZ0N, SZZ0U=>YRCLI%SZZ0U)
