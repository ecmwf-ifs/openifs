...
& NGPTOTG=>YDGEM%NGPTOTG, YPH9=>YDGMV%YPH9, YT1=>YDGMV%YT1, MSLB1GFL9=>YDPTRSLB1%MSLB1GFL9)
! -----------------------------------------------------------------------
...
DO JKGLO=1,NGPTOT,NPROMA
  ...
  ENDDO
  CALL GPHPRE(NPROMA,NFLEVG,IST,IEND,YDVAB,YDCVER,ZPRE0) 
      ...
      DO JLEV=1,NFLEVG
        DO JROF=IST,IEND
          ZDFLD=MAX(PGFLT1(JROF,JLEV,YCOMP(JGFL)%MP1,IBL),ZGFLMIN)&
                       & -ZPSCAL(JROF,JLEV,IBL)*PGFL(JROF,JLEV,YCOMP(JGFL)%MP9_PH,IBL)
      ...
      DO JKGLO=1,NGPTOT,NPROMA
        ...
        DO JLEV=1,NFLEVG
          DO JROF=IST,IEND
            ...
            ZF1=ZPSCAL(JROF,JLEV,IBL)*PGFL(JROF,JLEV,YCOMP(JGFL)%MP9_PH,IBL)+ZDIFF
      ...
      DO JKGLO=1,NGPTOT,NPROMA
        ...
        DO JLEV=1,NFLEVG
          DO JROF=IST,IEND
            ZDIFF=ZALPHA*ZDIFPOS(JROF,JLEV,JFIX,IBL)+ZINVAL*ZDIFNEG(JROF,JLEV,JFIX,IBL)
            PGFLT1(JROF,JLEV,YCOMP(JGFL)%MP1,IBL)=&
                   & ZPSCAL(JROF,JLEV,IBL)*PGFL(JROF,JLEV,YCOMP(JGFL)%MP9_PH,IBL)+ZDIFF
          ENDDO
        ENDDO
      ENDDO
!$OMP END PARALLEL DO
