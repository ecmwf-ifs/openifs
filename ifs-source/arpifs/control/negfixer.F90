...
& YDCVER=>YDGEOMETRY%YRCVER, YGFL=>YDML_GCONF%YGFL)
...
& NFLEVG=>YDDIMV%NFLEVG, NFLSA=>YDDIMV%NFLSA,   NGPTOT=>YDGEM%NGPTOT, NGPTOTG=>YDGEM%NGPTOTG,   YPH9=>YDGMV%YPH9,         &
...
!$OMP& PRIVATE(ZSPT0,ZSPT1,ZPRE0,ZPRE1)
  DO JKGLO=1,NGPTOT,NPROMA
    ...
    IBL=(JKGLO-1)/NPROMA+1
    DO JROF=IST,IEND
      ZSPT0(JROF)=PGMVS(JROF,YPH9%MSP,IBL)
