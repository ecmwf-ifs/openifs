...
SUBROUTINE TRMFIXERS(YDGEOMETRY,YDGMV,YDDPHY,YDML_GCONF,YDML_DYN,LD_CALL_SL,KL0,PLSCAW,PB1,YDSL,PGMVS,PGMVT1S,PGFL,&
                   & PGFLT1,PEXTRADYN)
!
...
IF (LTRCMFIX) THEN
  IF (LTRCMFBC.OR.LTRCMFP) THEN
    ...
    ENDIF
    CALL QMFIXER(YDGEOMETRY,YDGMV,YDDPHY,YGFL,YDML_DYN,KL0,PLSCAW,PB1,YDSL,PGMVS,PGMVT1S,PGFL,PGFLT1,PEXTRADYN)
