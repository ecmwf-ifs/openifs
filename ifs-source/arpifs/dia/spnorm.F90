...
SUBROUTINE SPNORM(YDGEOMETRY,YDML_GCONF,YDDYNA,YDSP,LDSPOR)
...
USE YOMCT0                 , ONLY : NSPPR, LREFOUT, LREFGEN, LELAM  
...
LOGICAL             ,OPTIONAL ,INTENT(IN) :: LDSPOR 
...
!              ----------------------
  ...
  IF(LLPRTAV) THEN
    ...
    ELSE
      WRITE(NULOUT,'(1X,A,1X,A,1X,E21.15)') TRIM(CLTEXT),CLSP,ZSPNORM
    ENDIF
