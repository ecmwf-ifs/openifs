...
SUBROUTINE WRMLPP(YDGEOMETRY,YDGFL,YDGFL5,YDSURF,YDSPEC,YDCFU,YDXFU,YDMODEL,CDCONF,PTRAJEC,YDMCUF)
...
!*       1.2   GRIB OUTPUT
  ...
  CALL WRMLPPG(YDGEOMETRY,YDGFL,YDGFL5,YDSURF,YDMODEL,YDSPEC,PTRAJEC=PTRAJEC)
