...
SUBROUTINE ENDVPOS(YDCST,KLMOD,YDQTYPE,YDAUX,YDCLIMO,YDNAMFPSCI,YDAFN,YDFPGEO,YDFPVAB,&
 & YDGEOMETRY,YDML_GCONF,YDDYNA,YDML_PHY_MF,LDZ0H,CDCONF, &
...
IASD0=IFPSEARCH(YDRQAUX,GFP%SDSL%ICOD)
...
!     GFPBUF(.,IATSI,.) is already a combination of interpolated Ts and SST
  ...
  ENDIF
  PGP(:,:,JBLOC) = 0.0_JPRB
  CALL ENDPOS(YDCST,YDQTYPE,YDNAMFPSCI,YDAFN,KLMOD,YDFPVAB,YDGEOMETRY,YDML_GCONF,YDDYNA,YDML_PHY_MF,LDZ0H, &
   & NFPROMA,IST,IEND,YDQTYPE%NFPAUXB,KPXLEV,CDCONF, &
