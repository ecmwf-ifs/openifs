...
!**** *FPGEOPHY*  - Full- POS geometry of output physical fields
...
INTEGER(KIND=JPIM) :: IJ, IPTR, INC, IU, IV, JF, JL, JF2, IPTR2, JI
...
IF (LHOOK) CALL DR_HOOK('FPGEOPHY',0,ZHOOK_HANDLE)
...
DO JF=1, KFIELDS
  ...
  IPTR=IPTR+INC
ENDDO
IF (IPTR-1 /= KFIELDS) CALL ABOR1('FPGEOPHY : INTERNAL ERROR 2')
