...
LLRQXFU=(YDFIELDS%YRXFU%NFDXFU > 0)
...
ALLOCATE(YDGFL%GFL(YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG,YDMODEL%YRML_GCONF%YGFL%NDIM,YDGEOMETRY%YRDIM%NGPBLKS))
