...
SUBROUTINE SCAN2M_VPOS(YDCST,YDQTYPE,YDNAMFPSCI,YDAFN,LDHPOS,YDVAB,YDGEOMETRY,YDGMV,YDGFL,YDSURF,YDXFU,KCUFNR,PMCUFGP, &
 & YDML_GCONF,YDDYN,YDDYNA,YDML_PHY_MF,CDCONF,KPXLEV,PXLEV,YDTFP_DYNDS,PAUX,PGPP)
...
DO JKGLO=1,NGPTOT,NPROMA
  ...
  CALL VPOS(YDCST,YDQTYPE,YDNAMFPSCI,YDAFN,LDHPOS,YDVAB,YDGEOMETRY,YDSURF,YDXFU,KCUFNR,PMCUFGP(:,:,IBL),YDML_GCONF,YDDYN,YDDYNA,YDML_PHY_MF, &
