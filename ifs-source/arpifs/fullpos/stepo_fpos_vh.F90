...
ASSOCIATE(YDCST=>YDMODEL%YRCST, YDFPGEOMETRY=>YDFPOS%YFPGEOMETRY, YDFPFILTERS=>YDFPOS%YFPFILTERS, YDFPVAB=>YDFPOS%YFPVAB, &
...
IF (YDQTYPE%NFPGT1 > 0 .OR. CDH == '0') THEN
  ...
  IF (CDH == 'A') THEN
    ...
    CALL SCAN2M_VPOS(YDCST,YDQTYPE,YDNAMFPSCI,YDAFN,LDHPOS,YDFPVAB,YDGEOMETRY,YDGMV,YDGFL,YDSURF,YDXFU,KCUFNR,PMCUFGP, &
     & YDMODEL%YRML_GCONF,YDMODEL%YRML_DYN%YRDYN,YDMODEL%YRML_DYN%YRDYNA,YDMODEL%YRML_PHY_MF,CDV,KPXLEV,PXLEV,TFP_DYNDS,ZAUX,ZGPP)
  ...
  ELSE
    ...
    CALL SCAN2M_VPOS(YDCST,YDQTYPE,YDNAMFPSCI,YDAFN,LDHPOS,YDFPVAB,YDGEOMETRY,YDGMV,YDGFL,YDSURF,YDXFU,KCUFNR,PMCUFGP, &
     & YDMODEL%YRML_GCONF,YDMODEL%YRML_DYN%YRDYN,YDMODEL%YRML_DYN%YRDYNA,YDMODEL%YRML_PHY_MF,CDV,KPXLEV,PXLEV,TFP_DYNDS,PFPBUF,ZGPP)
