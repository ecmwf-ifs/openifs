...
!      R. El Khatib 24-Jul-2020 NFPFFTW controlled by LFFTW
!      R. El Khatib 17-Dec-2020 Remove the case FPSTRET=-1. for academic domain ; use LFPMAP instead
!-----------------------------------------------------------------------

USE GEOMETRY_MOD , ONLY : GEOMETRY
USE PARKIND1,  ONLY : JPIM     ,JPRB
USE PARFPOS,   ONLY : JPOS3S
...
USE YOMCST,    ONLY : RPI
USE YOMTRANS , ONLY : LUSEFLT, LFFTW
