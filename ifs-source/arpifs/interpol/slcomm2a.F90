...
!     Externals.
!     ----------
!        MPL_BARRIER, MPL_SEND, MPL_RECV, MPL_WAIT, MPL_WAITANY
...
USE MPL_MODULE, ONLY : MPL_BARRIER, MPL_SEND, MPL_RECV, MPL_WAIT, MPL_WAITANY, JP_NON_BLOCKING_STANDARD
! arp/ifs dependencies to be solved later.
USE YOMMP0   , ONLY : NPRCIDS, LSLDEBUG, LSYNC_SLCOM2
...
IF (LSYNC_SLCOM2) THEN
  CALL MPL_BARRIER(CDSTRING='SLCOMM2A:SLCOMM2A_INT')
ENDIF
