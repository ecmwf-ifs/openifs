...
! SOA..
  ...
  ! Boundary conditions at surface for stratospheric species in IFS(CB05BASCOE)
  ! which currently don't feature emissions (!)
  ! The corresponding list for IFS(BASCOE)-only experiments is given in 'bascoe_module'.
  ...
  ! Just a simple parameter, taken from BASCOE field for 2008
  ! Units in [mole/mole]
