...
CONTAINS
  ...
  SUBROUTINE AUX_DIAG_TYPE_INIT(SELF, REGISTRY, NLEV, PERSISTENT)
    ...
    SELF%F_PPDEPL => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    ...
    SELF%F_PM10DEGL => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    SELF%F_PTROPOTP => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    SELF%F_PVISIH => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    SELF%F_PVDISCU => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    ...
    SELF%F_ZCAPE => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, NLEV=4, PERSISTENT=PERSISTENT)
    SELF%F_PCIN => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, NLEV=3, PERSISTENT=PERSISTENT)
    ...
    SELF%F_PKM_VDF => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, NLEV=NLEV, PERSISTENT=PERSISTENT)
    SELF%F_ZRI => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, NLEV=NLEV, PERSISTENT=PERSISTENT)
    ...
    SELF%F_PCHARGE_LIG => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    SELF%F_ZEIS => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    SELF%F_ZINV => CREATE_TEMPORARY(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    ...
    SELF%F_ICBOT_LIG => CREATE_TEMPORARY_INT2D(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
    SELF%F_ICTOP_LIG => CREATE_TEMPORARY_INT2D(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
 END SUBROUTINE AUX_DIAG_TYPE_INIT
  ...
  SUBROUTINE AUX_DIAG_TYPE_FINAL(SELF)
    ...
    CALL DELETE_TEMPORARY(SELF%F_PPDEPL)
    ...
    CALL DELETE_TEMPORARY(SELF%F_PM10DEGL)
    CALL DELETE_TEMPORARY(SELF%F_PTROPOTP)
    CALL DELETE_TEMPORARY(SELF%F_PVISIH)
    CALL DELETE_TEMPORARY(SELF%F_PCIN)
    CALL DELETE_TEMPORARY(SELF%F_PVDISCU)
    ...
    CALL DELETE_TEMPORARY(SELF%F_PKM_VDF)
    CALL DELETE_TEMPORARY(SELF%F_ZRI)
    ...
    CALL DELETE_TEMPORARY(SELF%F_PCHARGE_LIG)
    CALL DELETE_TEMPORARY(SELF%F_ZEIS)
    CALL DELETE_TEMPORARY(SELF%F_ZINV)
    ...
    CALL DELETE_TEMPORARY(SELF%F_ICBOT_LIG)
    CALL DELETE_TEMPORARY(SELF%F_ICTOP_LIG)
