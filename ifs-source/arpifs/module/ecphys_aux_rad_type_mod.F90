...
TYPE AUX_RAD_TYPE
  ...
  CLASS(FIELD_2RB), POINTER :: F_PSRLWDC, F_PSRSWD, F_PSRSWDC, F_PSRSWDCS, F_PEDRO, F_PSRSWPAR, F_PSRSWUVB, &
   & F_PSRSWPARC, F_PSRSWTINC, F_PSRFDIR, F_PSRCDIR, F_PTINCF, F_PFDIR, F_PCDIR, F_PDSRP, F_PISUND, F_PINCSR, F_PINCSR0
  CLASS(FIELD_3RB), POINTER :: F_PSRLWD, F_PNEB, F_PQICE, F_PQLI, F_PEMTD, F_PTRSW, F_PEMTC, F_PTRSC, F_PHRSW, F_PHRLW, &
   & F_PHRSC, F_PHRLC, F_DERIVATIVELW
  CLASS(FIELD_4RB), POINTER :: F_PTAUAER
