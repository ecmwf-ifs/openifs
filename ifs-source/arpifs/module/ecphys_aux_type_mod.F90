...
TYPE KEYS_LOCAL_TYPE
  LOGICAL, DIMENSION(:), POINTER, CONTIGUOUS  :: LLLAND, LLSICE, LLNH, LLCUM, LLSC, LLSHCV, LLCUM_LIG
  ...
  ! Storage fields to provide thread-local views
  CLASS(FIELD_2LM), POINTER :: F_LLLAND, F_LLSICE, F_LLNH, F_LLCUM, F_LLSC, F_LLSHCV, F_LLLAKE, F_LLOCN_KPP, F_LLCUM_LIG
...
CONTAINS
  ...
  SUBROUTINE KEYS_LOCAL_TYPE_INIT(SELF, REGISTRY, PERSISTENT)
    ...
    SELF%F_LLCUM_LIG => CREATE_TEMPORARY_LOG2D(GEOM=REGISTRY%GEOM, PERSISTENT=PERSISTENT)
  ...
  SUBROUTINE KEYS_LOCAL_TYPE_FINAL(SELF)
    ...
    CALL DELETE_TEMPORARY(SELF%F_LLCUM_LIG)
