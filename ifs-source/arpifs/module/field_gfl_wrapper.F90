...
CALL SET_MAP(FVAR,YDMAP%MT0_MAP,FID%SM_CDRFL,YSD_SM%YCDRFL%MP,YDSURF=YSD_SM%YCDRFL)
CALL SET_MAP(FVAR,YDMAP%MT0_MAP,FID%SM_CRRFL,YSD_SM%YCRRFL%MP,YDSURF=YSD_SM%YCRRFL)
