...
USE RTTOV_CONST , ONLY : INST_ID_AMSUA, INST_ID_ATMS, INST_ID_MHS,INST_ID_AMSUB, &
                       & INST_ID_MWHS2, INST_ID_MWTS3, INST_ID_TROPICS, &
                       & INST_ID_MWS, INST_ID_AWS
...
ELSEIF(KCDTYPE == NSSMI)THEN
  ...
  IF(ANY(KSENSOR == (/INST_ID_AMSUA, INST_ID_ATMS, INST_ID_MHS,INST_ID_AMSUB, & 
   &                  INST_ID_MWHS2, INST_ID_MWTS3, INST_ID_TROPICS, &
   &                  INST_ID_MWS, INST_ID_AWS/) )) THEN
    GET_2DGOM_TREATMENT = JP_TREAT_2DGOM_SLANT_PATH
  ELSE
