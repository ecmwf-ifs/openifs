...
USE FIELD_REGISTRY_MOD, ONLY : CREATE_TEMPORARY, CREATE_FIELD_WRAP, DELETE_TEMPORARY
...
SUBROUTINE TPG_TYPE_INIT(SELF, YDGEOMETRY, PGEO0, LPGFSF)
  ...
  SELF%F_PHI0F  => CREATE_FIELD_WRAP(DATA=PGEO0)  ! Wrapping an existing array
  SELF%F_PHI0FL => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=.false.)
  SELF%F_PHI0FM => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=.false.)
  SELF%F_RT0    => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=.false.)
  SELF%F_RT0L   => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=.false.)
  SELF%F_RT0M   => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=.false.)
  SELF%F_PHI0H  => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV+1, NLEV0=0, PERSISTENT=.false.)
  SELF%F_PHI0HL => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV+1, NLEV0=0, PERSISTENT=.false.)
  SELF%F_PHI0HM => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV+1, NLEV0=0, PERSISTENT=.false.)
  SELF%F_PSGRTL => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=LPGFSF)
  SELF%F_PSGRTM => CREATE_TEMPORARY(YDGEOMETRY, NLEV=NLEV, PERSISTENT=LPGFSF)
...
SUBROUTINE TPG_TYPE_FINAL(SELF)
  ...
  IF (ASSOCIATED(SELF%F_PHI0F))  CALL DELETE_TEMPORARY(SELF%F_PHI0F)
  IF (ASSOCIATED(SELF%F_PHI0FL)) CALL DELETE_TEMPORARY(SELF%F_PHI0FL)
  IF (ASSOCIATED(SELF%F_PHI0FM)) CALL DELETE_TEMPORARY(SELF%F_PHI0FM)
  IF (ASSOCIATED(SELF%F_RT0))    CALL DELETE_TEMPORARY(SELF%F_RT0)
  IF (ASSOCIATED(SELF%F_RT0L))   CALL DELETE_TEMPORARY(SELF%F_RT0L)
  IF (ASSOCIATED(SELF%F_RT0M))   CALL DELETE_TEMPORARY(SELF%F_RT0M)
  IF (ASSOCIATED(SELF%F_PHI0H))  CALL DELETE_TEMPORARY(SELF%F_PHI0H)
  IF (ASSOCIATED(SELF%F_PHI0HL)) CALL DELETE_TEMPORARY(SELF%F_PHI0HL)
  IF (ASSOCIATED(SELF%F_PHI0HM)) CALL DELETE_TEMPORARY(SELF%F_PHI0HM)
