...
MODULE SUBROUTINE MODEL_CREATE(SELF, YDGEOMETRY, CDNAMELIST, LDLINEAR, KGFLCONF,K_SELF, PTSTEP)
...
USE YOMCT0,       ONLY : NCONF, CNMEXP
USE YOMARG,       ONLY : LELAM, LECMWF
...
INTEGER(KIND=JPIM) :: IOS,IMINUT, ISTAT
...
#include "chem_init_tlad.intfb.h"
...
CALL SUDYNA(YDGEOMETRY,SELF%YRML_DYN%YRDYNA,NULOUT)
...
CALL SURIP(YDGEOMETRY%YRDIM,SELF%YRML_DYN%YRDYNA,SELF%YRML_GCONF%YRRIP,PTSTEP=PTSTEP)
...
CALL SUGRIB(SELF%YRML_PHY_EC%YREPHY,SELF%YRML_PHY_G%YRDPHY)
