...
!  C. Burrows (Apr 2025) : Add HIRAS-2
!-----------------------------------------------------------------------------
...
USE RTTOV_CONST  , ONLY : NINST, INST_ID_HIRS, INST_ID_MSU, INST_ID_VTPR1, INST_ID_VTPR2, INST_ID_AIRS, &
 ...
 & INST_ID_MWHS, INST_ID_IRAS, INST_ID_ABI, INST_ID_AHI, INST_ID_GIIRS, INST_ID_HIRAS, INST_ID_HIRAS2, INST_ID_IKFS2, INST_ID_FCI
...
INTEGER(KIND=JPIM), PARAMETER :: JPMXSATIDS=125
...
LRTCALC_HRETR (INST_ID_HIRAS2) = .TRUE.
LRTCALC_HRETR (INST_ID_FCI) = .TRUE.
