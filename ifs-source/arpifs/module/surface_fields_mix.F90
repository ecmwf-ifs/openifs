...
TYPE TYPE_SFL_VDIAG
  ...
  TYPE(TYPE_SURF_MTL_2D), POINTER :: YACH4     =>NULL()  ! Accumulated wetland CH4 flux  
...
TYPE TYPE_SFL_SATSIM
  ...
  TYPE(TYPE_SURF_MTL_3D), POINTER :: YCDRFL=>NULL()      ! Cloudy reflectance
  TYPE(TYPE_SURF_MTL_3D), POINTER :: YCRRFL=>NULL()      ! Clear-sky reflectance
...
TYPE TYPE_SFL_WAM
  ...
  TYPE(TYPE_SURF_MTL_2D), POINTER :: YUSTRW=>NULL()     ! U-component of ocean surface stress passed to the wave model (WAM).
  TYPE(TYPE_SURF_MTL_2D), POINTER :: YVSTRW=>NULL()     ! V-component of ocean surface stress passed to the wave model (WAM).
