...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSO4GROWTH_RHTAB SUM = ', SUM(SELF%RSO4GROWTH_RHTAB)
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNIGROWTH_RHTAB SUM = ', SUM(SELF%RNIGROWTH_RHTAB)
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RAMGROWTH_RHTAB SUM = ', SUM(SELF%RAMGROWTH_RHTAB)
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'ROMGROWTH_RHTAB SUM = ', SUM(SELF%ROMGROWTH_RHTAB)
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSOAGROWTH_RHTAB SUM = ', SUM(SELF%RSOAGROWTH_RHTAB)
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RRHO_OM SUM = ', SELF%RRHO_OM
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RRHO_BC SUM = ', SELF%RRHO_BC
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RRHO_AM SUM = ', SELF%RRHO_AM
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RRHO_ASH SUM = ', SELF%RRHO_ASH
