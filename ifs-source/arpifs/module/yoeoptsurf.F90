...
! Include photosynthesis surface parameters that are optimized with observations (passed via namelist to surface model)
...
!     -----------------------------------------------------------------
!
!  *YOEOPTSURF* CONTAINS CONSTANT PARAMETERS FOR THE LAND SURFACE THAT HAVE BEEN OPTIMIZED WITH OBSERVATIONS
!
