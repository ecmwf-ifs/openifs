...
!     *NGRIB_HANDLE_FOR_WAM GRIB HANDLE USED TO EXCHANGE GRIB INFORMATION (GRIB1 or GRIB2 depending on YOWGRIBHD : NGRIB_VERSION 
!     *NGRIB_HANDLE_FOR_WAM2 GRIB2 HANDLE USED TO EXCHANGE GRIB INFORMATION
...
INTEGER(KIND=JPIM) :: NGRIB_HANDLE_FOR_WAM2
