...
USE YOM_YGFL, ONLY : JPGHG_ASSIM, JPCHEM_ASSIM, JPAEROCV
...
! NGRBAERCV(JPAEROCV)       : Gribcodes of assimilated AER fields
...
INTEGER(KIND=JPIM), DIMENSION(JPAEROCV)  :: NGRBAERCV
