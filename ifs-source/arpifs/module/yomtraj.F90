...
TYPE TRAJ_PHYS_TLAD_TYPE
  ...
  REAL (KIND=JPRB), DIMENSION (:,:), POINTER :: PTENTVD5=>NULL(), PTENQVD5=>NULL(), PTENUVD5=>NULL(), &
   ...
   & PTENUCO5=>NULL(), PTENVCO5=>NULL(), PTENTSL5=>NULL(), PTENQSL5=>NULL(), PQLIVD5=>NULL(), PICEVD5=>NULL(), &
   & PTENTSS5=>NULL(), PTENQSS5=>NULL()
  ...
  ! VDIFF quantities for next timestep convection
  REAL (KIND=JPRB), DIMENSION (:), POINTER :: PDIFTQ_S5=>NULL(),PDIFTS_S5=>NULL()
  REAL (KIND=JPRB),DIMENSION(:,:), POINTER :: PTENT_VD95=>NULL(),PTENQ_VD95=>NULL(),PTENU_VD95=>NULL(),PTENV_VD95=>NULL()
  ! MF fields
