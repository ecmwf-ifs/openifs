...
REAL(KIND=JPRB),PROTECTED :: RCOEFSO2         ! Cooef. std. SO2 CHEM
REAL(KIND=JPRB),PROTECTED :: RCOEFVSO2        ! Cooef. std. VSO2 CHEM
REAL(KIND=JPRB),PROTECTED :: RCOEFHCHO        ! Cooef. std. HCHO CHEM
