...
SUBROUTINE WRITE_SPEC_GRIB(YDGEOMETRY,YDRIP,CDFILE,YDSPEC,CDMODE,CDLEVTYPE,KSECLOC)
...
!        M.Leutbecher  08-Aug-2024 Introduced CDLEVTYPE dummy argument  
! ------------------------------------------------------------------
...
CLLEVTYPE="ML"
IF (PRESENT(CDLEVTYPE)) CLLEVTYPE=CDLEVTYPE
IOPROC=1
...
CALL SETUP_IOSTREAM(YL_IOSTREAM,'CIO',TRIM(CDFILE),CDMODE=CLMODE,&
 & KIOMASTER=IOPROC)
CALL SETUP_IOREQUEST(YL_IOREQUEST,'SPECTRAL_FIELDS',LDGRIB=.TRUE.,CDLEVTYPE=CLLEVTYPE,&
