...
! nor does it submit to any jurisdiction
      ...
      &    PZ0M,PUSTR,PT,PDUST_REBOUND,PVRES)
...
! OUTPUTS:
! --------
! PVRES      : DRY DEPOSITION RESISTANCE  (s.m-1)
...
IF (PWETD < 2.5E-6_JPRB) THEN
  IF (JLAND > 10) THEN
    ZVDS=ZA1(JLAND2)*PUSTR*EXP(MAX(0._JPRB,1.5_JPRB*PLAI/ZLAIMAX(JLAND)))
  ELSE
...
IF (ZVBA > 0._JPRB .AND. PRHO > 0._JPRB .AND. ZVISC > 0._JPRB) THEN
