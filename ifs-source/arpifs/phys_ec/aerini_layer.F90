...
SELECT CASE (TRIM(AERO_SCHEME))
 ...
 &  KDIM%KTILES, KDIM%KSTGLO, GEMSL%ITRAC, GEMSL%IAERO, &
 ...
 &  ZSNM , PSURF%PSP_RR(:,YSP_RR%YT%MP9)  , PAUX%PGELAM, PAUX%PGELAT, PAUX%PGEMU, &
 ...
 &  GEMSL%ZAERDDP, GEMSL%ZAERSDM, GEMSL%ZAERSRC, GEMSL%ZAERFLX, &
