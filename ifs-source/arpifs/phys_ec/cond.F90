...
ASSOCIATE(REPFLM=>YDECND%REPFLM, &
 & RG=>YDCST%RG, R=>YDCST%R, RCPD=>YDCST%RCPD, RLVTT=>YDCST%RLVTT, RLSTT=>YDCST%RLSTT, &
...
!*                     AND TOTAL FLUXES
  ...
  ELSE
    CALL CUADJTQ(YDTHF, YDCST, YDEPHLI,KIDIA,KFDIA,KLON,KLEV,IK,ZPP,ZTT,ZQQ,LLFLAG,ICALL)
  ENDIF
