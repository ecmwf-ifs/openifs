...
!     F. Vana 14-Feb-2023  Ozone moved to SLTEND2
!
!-----------------------------------------------------------------------
...
ASSOCIATE(YGFL=>YDMODEL%YRML_GCONF%YGFL,YDEPHY=>YDMODEL%YRML_PHY_EC%YREPHY,YDCST=>YDMODEL%YRCST)
...
CALL SLTEND(YDMODEL, KDIM%KIDIA, KDIM%KFDIA, KDIM%KLON, KDIM%KLEV, &
  & YDMODEL%YRML_PHY_G%YRSLPHY%NVTEND, &
