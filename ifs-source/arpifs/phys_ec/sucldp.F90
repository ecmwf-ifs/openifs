...
!        R.Forbes      May-2022    Added precip type severity definition
!        R. Forbes     May-2023    Added multipliers for ice/rain fallspeeds
!     ------------------------------------------------------------------
...
REAL(KIND=JPRB), POINTER :: RXFALLSPEEDRAIN, RXFALLSPEEDICE, RTAU_CLD_TLAD
...
ASSOCIATE(NFLEVG=>YDDIMV%NFLEVG, TSPHY=>YDPHY2%TSPHY, &
 ...
 & RCL_CONST8S=>YDECLDP%RCL_CONST8S, &
...
RXFALLSPEEDRAIN = 1.0_JPRB ! Multiplier for rain fallspeed
RXFALLSPEEDICE  = 1.0_JPRB ! Multiplier for ice fallspeed
