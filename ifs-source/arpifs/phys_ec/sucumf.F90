...
REAL(KIND=JPRB), POINTER :: RMFSOLUV, RMFSOLTQ, RMFSOLCT, RMFSOLRHS, ENTRORG, ENTR_RH, ENTSHALP,&
 ...
 & RCAPQADV, RXMIN, RTAULIM, RTAUFAC
LOGICAL, POINTER :: LMFPEN, LMFCUCA, LMFSCV, LMFDUDV, LMFDSNOW, LMFWETB, LMFGLAC, LSCVLIQ, LMFENTHCONS, LNEWTAU
...
RXMIN     => YDECUMF%RXMIN
RTAULIM   => YDECUMF%RTAULIM
RTAUFAC   => YDECUMF%RTAUFAC
ENTR_RH   => YDECUMF%ENTR_RH
...
LNEWTAU =.FALSE.  ! New formulation for resolution dependence of closure

!      MODULATION OF CLOSURE IF LNEWTAU
!      --------------------------------
...
WRITE(UNIT=NULOUT,FMT='('' RCAPDCYCL= '',E12.5 &
 & ,'' RCAPQADV= '',E12.5)') &
 & RCAPDCYCL, RCAPQADV
WRITE(UNIT=NULOUT,FMT='('' LNEWTAU = '',L5&
 & ,'' RXMIN = '',E12.5,'' RTAULIM = '',E12.5,'' RTAUFAC = '',E12.5,'' ENTR_RH = '',E12.5)')&
 & LNEWTAU,RXMIN,RTAULIM,RTAUFAC,ENTR_RH
