...
ASSOCIATE(LCENTREDTIMESZA=>YDML_PHY_RAD%YRERAD%LCENTREDTIMESZA, LPERPET=>YDML_PHY_RAD%YRERAD%LPERPET, &
 ...
 & RPI=>YDCST%RPI, RDAY=>YDCST%RDAY, REA=>YDCST%REA, REPSM=>YDCST%REPSM, RI0=>YDCST%RI0, &
 & RCPV=>YDCST%RCPV, RETV=>YDCST%RETV, RCW=>YDCST%RCW, RCS=>YDCST%RCS, RTT=>YDCST%RTT, &
 & RLVTT=>YDCST%RLVTT, RLSTT=>YDCST%RLSTT, RALPW=>YDCST%RALPW, RBETW=>YDCST%RBETW, &
