...
ASSOCIATE( NJKT12=>YDECUMF2%NJKT12, NJKT22=>YDECUMF2%NJKT22, NJKT32=>YDECUMF2%NJKT32, &
         ...
         & R5LES=>YDTHF%R5LES,R5IES=>YDTHF%R5IES,R5ALVCP=>YDTHF%R5ALVCP,&
         & R5ALSCP=>YDTHF%R5ALSCP,RALVDCP=>YDTHF%RALVDCP,&
         & RALSDCP=>YDTHF%RALSDCP,RTWAT=>YDTHF%RTWAT,&
         & RTICE=>YDTHF%RTICE,RTICECU=>YDTHF%RTICECU,&
...
CALL SATUR (YDTHF, YDCST, KIDIA , KFDIA , KLON  , NJKT22 , KLEV, YDEPHLI%LPHYLIN,&
          & PAPM1 , PTM1  , ZQSAT , 1  )
