...
&                          NGRIB_HANDLE_IFS, NGRIB_HANDLE_IFS2
...
& NGRIB_HANDLE_FOR_WAM2=>YREWCOU%NGRIB_HANDLE_FOR_WAM2, &
& KSTPW=>YREWCOU%NSTPW &
&)
...
IF(.NOT.LWINIT) THEN
  ...
  !!!!! Until we get a proper grib2 template for the wave spectra, we will user grib 1 to code them.
  !!!!! See also ecWAM preset_wgrib_template.F90
  CALL WVCOUPLE_UPDATE_GRIB_HANDLES(LWINIT, KSTPW, PTSTEP, NSTEP, LPPSTEPS, 1, NGRIB_HANDLE_FOR_WAM)
  NGRIB_HANDLE_IFS=NGRIB_HANDLE_FOR_WAM
  CALL PRESET_WGRIB_TEMPLATE("S",NGRIB_HANDLE_WAM_S)

  CALL WVCOUPLE_UPDATE_GRIB_HANDLES(LWINIT, KSTPW, PTSTEP, NSTEP, LPPSTEPS, NGRIB_VERSION, NGRIB_HANDLE_FOR_WAM)
  NGRIB_HANDLE_IFS=NGRIB_HANDLE_FOR_WAM
  CALL PRESET_WGRIB_TEMPLATE("I",NGRIB_HANDLE_WAM_I)

  CALL WVCOUPLE_UPDATE_GRIB_HANDLES(LWINIT, KSTPW, PTSTEP, NSTEP, LPPSTEPS, 2, NGRIB_HANDLE_FOR_WAM2)
  NGRIB_HANDLE_IFS2=NGRIB_HANDLE_FOR_WAM2
