...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PRAER(6,6) ! LW absorption coefficients
...
ASSOCIATE(NFLEVG=>YDDIMV%NFLEVG, RAER=>PRAER)
ZEPSEC = 1.E-06_JPRB
...
!  by interpolating data from stored reference atmospheres. 
  ...
  CALL RRTM_SETCOEF_140GP(KIDIA,KFDIA,KLEV,Z_COLDRY,Z_WBRODL, Z_WKL,&
  ...
  CALL RRTM_GASABS1A_140GP(KIDIA,KFDIA,KLEV,Z_ATR1,Z_OD,Z_TF1,Z_PAVEL,Z_COLDRY,Z_COLBRD,Z_WX,&
