...
IF(LESCALE) THEN
  ...
  ENDDO
  CALL GPHPRE(KPROMA,KLEV,IST,IPROF,YDVAB,YDCVER,ZPESCH,PXYB=ZXYBE,PRESF=ZPESCF)
...
IF(LESCALE) THEN
  ...
  CALL GPRCP(KPROMA,IST,IPROF,KLEV,PQ=ZGFLE(1,1,YDKC%IQ),PQI=ZGFLE(1,1,YDKC%II),&
