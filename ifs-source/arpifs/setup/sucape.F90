...
USE YOMCAPE  , ONLY :  NCAPEITER   ,NETAPES  ,NCAPEPSD ,GCAPERET   ,GCAPEPSD &
  &, GMISCINV, GCINMAX, LADAE, LMCAPEA,GCAPEMIN
...
WRITE(KULOUT,'('' NCAPEITER = '',I2,'' NETAPES = '',I2,'' NCAPEPSD = '',I2, &
 & '' GCAPERET = '',E13.6,'' GCAPEPSD = '',E13.6,'' GMISCINV = '',E13.6, &
 & '' GCAPEMIN = '',E13.6,'' GCINMAX = '',E13.6)')                         &
 & NCAPEITER, NETAPES, NCAPEPSD, GCAPERET, GCAPEPSD, GMISCINV, GCAPEMIN, GCINMAX
WRITE(KULOUT,FMT=*) 'LADAE=',LADAE,' LMCAPEA=',LMCAPEA
