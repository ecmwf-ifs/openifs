...
#if defined(__PGI)
USE PAR_GFL,      ONLY : JPGFL, JPNAMED_GFL, JPGHG, JPCHEM, JPGHG_ASSIM, JPCHEM_ASSIM, JPAERO, &
 & JPFORC, JPERA40, JPSLDIA, JPEZDIAG, JPCH4S, JPNOGW, JPAEROUT, JPAEROCLIM, JPUVP, JPPHYS, JPPHYCTY, &
 & JPFSD, JPEDRP, JPLIMA
...
LOGICAL, POINTER :: LCHEM_DIA, LCHEM_DDFLX, LCOMPO_DDFLX_DIR, LCHEM_TROPO, &
 ...
 & LAERSOA, LAERSOA_COUPLED, LAERRESUSPENSION, LAERNUCL, LCHEM_ARPCLIM
...
#if defined(__PGI) || defined (__NVHPC)
...
TYPE(TYPE_GFL_NAML) :: &
 ...
 & YEXT_NL(JPGFL-JPNAMED_GFL-JPGHG-JPFORC-JPEZDIAG-JPAERO-JPERA40-JPNOGW-JPSLDIA-&
 &         JPCH4S-JPAEROUT-JPAEROCLIM-NPAERAOT-NPAERLISI-JPUVP-JPCHEM-JPLIMA-&
 &         JPPHYCTY-JPFSD-JPEDRP)
#else
...
WRITE(NULOUT,'(A,L2,A,L2,A,L2,A,L2,A,L2,A,L2,A,L2)')&
  & '  LTRCMFP=',LTRCMFP,&
  & '  LTRCMFBC=',LTRCMFBC,&
  & '  LTRCMFPR=',LTRCMFPR,&
  & '  LTRCMFMG=',LTRCMFMG,&
...
!   & '  LCHEM_DIA=',LCHEM_DIA, &
  ...
  WRITE(NULOUT,'(4(A,I2),A,I6,9(A,L2))')&
