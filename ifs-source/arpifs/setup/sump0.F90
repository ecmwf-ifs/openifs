...
!      R. El Khatib 10-May-2022 force LEQ_REGIONS=F if LELAM
!     ------------------------------------------------------------------
...
USE YOMMP0   , ONLY : NPROC, LSPLIT, LSPLITOUT, NWRTOUT, NSTRIN, NSTROUT, &
 ...
 & LSYNC_SLCOM,LSYNC_SLCOM2,LSYNC_CALSL, LSYNC_TRANS, M_BARRINC_DIWRGRID, &
 & NDISTIO, LUSEWRGRIDALL, NPRINTLEV, NPRTRW, MYSETW, NPRTRV, MYSETV, &
 & L_GATHERV_WRGP, LSLDEBUG, LSLONDEM,NTRANS_SYNC_LEVEL
...
LEQ_REGIONS=LEQ_REGIONS.AND..NOT.LELAM
...
WRITE(IU,'('' LSYNC_SLCOM2 = '',L2)') LSYNC_SLCOM2
WRITE(IU,'('' LSYNC_CALSL = '',L2)') LSYNC_CALSL
