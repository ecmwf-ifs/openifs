...
! Optimized values with FLUXNET2015 and BFAS global scaling (2013-2020) (adapted for climate.v021 onwards)
  ...
  RVR0VT(2,2) =0.302E-07_JPRB   ! C4 grass (used to be long grass)
...
ELSE 
  ...
  RVR0VT(2,2)=0.150E-06_JPRB !C4 grass (used to be long grass PFT7)
...
RVCMAX25(2,2)=40.3_JPRB   ! C4 grass (used to be same as PFT7 long grass) 
...
RHUMREL(2,2)=1.0_JPRB   ! C4 grass (same as as old PFT7 long grass) 
...
RG0(7,1)=0.00699_JPRB ! Mixed Crops (C4 CROPS) 
...
RG0(2,2)=0.017_JPRB    ! C4 grass (same as old PFT7 long grass)
...
RVR0VT(7,1)=OVR0VT(7)   ! Mixed Crops C3
...
RVR0VT(7,2)=RVR0VT(1,2)   ! Mixed Crops (C4 CROPS) 
...
RVCMAX25(7,1)=OVCMAX25(7)    ! Mixed Crops C3
...
RHUMREL(7,1)=OHUMREL(7) ! Mixed Crops C3
...
RHUMREL(7,2)=RHUMREL(1,2)  ! C4 Mixed Crops
...
RG0(7,2)=RG0(1,2) ! C4 mixed Crops
