...
CALL GPHPRE(JPLL,NFLEVG,JPLL,JPLL,YDVAB,YDCVER,ZPRES,PXYB=ZXYB,PRESF=ZPRESF,LALPHA=.NOT.YDCVER%LVERTFE,&
...
IF (LESIDG) THEN
  SITIME=-1.0_JPRB
  CALL SUEHEG(YDGEOMETRY,YDDYN,YDDYNA,YDEDYN,YDRIP)
ENDIF
...
IF (LDYN_STABAN .OR. YDGEOMETRY%YRCVER%LDYN_ANALYSIS_STABILITY) THEN
  CALL SUDYN_STABILITY(YDGEOMETRY,YDDYN,YDDYNA,KULOUT)
ENDIF
