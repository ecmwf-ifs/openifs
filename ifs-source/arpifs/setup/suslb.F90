...
SUBROUTINE SUSLB(YDDIMV,YDCVER,YDMODEL)
...
!   F. Vana  11-Sep-2020: SLAVEPP in TL/AD
...
INTEGER(KIND=JPIM) :: IGFLP9, IGFLP95
...
INTEGER(KIND=JPIM) :: IZR95
INTEGER(KIND=JPIM) :: INUMGFL
INTEGER(KIND=JPIM) :: INUMGFL_SPL, INUMGFL_SLP
...
ASSOCIATE(NUMFLDS=>YGFL%NUMFLDS, NUMFLDS_SL1=>YGFL%NUMFLDS_SL1, &
 & NDIMSLP=>YGFL%NDIMSLP,NUMFLDS_SPL=>YGFL%NUMFLDS_SPL, NFLEVG=>YDDIMV%NFLEVG, &
 & L2TLFF=>YDDYN%L2TLFF, &
 & LADVF=>YDDYN%LADVF, &
 ...
 & LSLHDHEAT=>YDDYN%LSLHDHEAT, LAGPHY=>YDEPHY%LAGPHY, LEPHYS=>YDEPHY%LEPHYS, &
 ...
 & MSLB1GFLP95=>YDPTRSLB15%MSLB1GFLP95, &
 ...
 & MSLB1ZR9=>YDPTRSLB1%MSLB1ZR9, MSLB1Z0=>YDPTRSLB1%MSLB1Z0, &
 & MSLB1ZP9=>YDPTRSLB1%MSLB1ZP9, MSLB1Z9=>YDPTRSLB1%MSLB1Z9, &
 ...
 & MSLB1Z05=>YDPTRSLB15%MSLB1Z05, MSLB1Z95=>YDPTRSLB15%MSLB1Z95, &
 & MSLB1ZR95=>YDPTRSLB15%MSLB1ZR95, &
 ...
 & MSLB1UP95=>YDPTRSLB15%MSLB1UP95, MSLB1VP95=>YDPTRSLB15%MSLB1VP95,&
 & MSLB1ZP95=>YDPTRSLB15%MSLB1ZP95, MSLB1TP95=>YDPTRSLB15%MSLB1TP95,&
 ...
 & MSLB2STDDISW=>YDPTRSLB2%MSLB2STDDISW, MSLB2STDDISU5=>YDPTRSLB2%MSLB2STDDISU5,& 
 & MSLB2STDDISV5=>YDPTRSLB2%MSLB2STDDISV5, MSLB2STDDISW5=>YDPTRSLB2%MSLB2STDDISW5,&
 & MSLB2T15=>YDPTRSLB2%MSLB2T15, &
 ...
 & MSLB2ZRL=>YDPTRSLB2%MSLB2ZRL, MSLB2ZRL5=>YDPTRSLB2%MSLB2ZRL5, &
 ...
 & LRHS_CURV=>YDDYN%LRHS_CURV, LSLDP_XYZ=>YDDYN%LSLDP_XYZ,&
 & LSLHD=>YDDYNA%LSLHD,LRDBBC=>YDDYNA%LRDBBC,NVDVAR=>YDDYNA%NVDVAR,&
 & LGWADV=>YDDYNA%LGWADV,L3DTURB=>YDDYNA%L3DTURB,LCOMAD=>YDDYNA%LCOMAD, &
 & LSLINL=>YDDYNA%LSLINL,LSLINLC2=>YDDYNA%LSLINLC2,LSETTLS=>YDDYNA%LSETTLS, &
...
! * MSLB2STDDIS[x]5
MSLB2STDDISU5=NUNDEFLD
MSLB2STDDISV5=NUNDEFLD
MSLB2STDDISW5=NUNDEFLD
...
IF (LSLDP_XYZ) THEN
  MSLB2ZRL = IPTX
  IF (LLP) WRITE(IU,'(1X,A12,2I4)') 'MSLB2ZRL  = ',IPTX,NFLEVG
  IPTX    = IPTX + NFLEVG
ENDIF

IPTR2     = IPTX

LLSLAD=YDDYNA%LSLAG.AND.(NCONF == 131.OR.NCONF == 401.OR.NCONF == 501&
...
IF (LLSLAD) THEN
  ...
  IF (LSLDP_XYZ) THEN
    MSLB2ZRL5 = IPTX
    IF (LLP) WRITE(IU,'(1X,A12,2I4)') 'MSLB2ZRL5  = ',IPTX,NFLEVG
    IPTX    = IPTX + NFLEVG
  ENDIF
  IPTR2   = IPTX
ENDIF

IF (YDDYNA%LSPRT.AND.(NCONF == 131.OR.NCONF == 401.&
...
IF (YDDYNA%LNHDYN.AND.LGWADV.AND.YDCVER%LVERTFE.AND.YDCVER%LVFE_GW) THEN
  MSLB2GWF = IPTX
...
IF (LCOMAD) THEN
  ...
  IF (LLSLAD) THEN
    MSLB2STDDISU5 = IPTX
    IF (LLP) WRITE(IU,'(1X,A12,2I4)') 'MSLB2STDDISU5= ',IPTX,NFLEVG
    IPTX    = IPTX + NFLEVG
    IPTR2    = MAX(IPTX,IPTR2)
    MSLB2STDDISV5 = IPTX
    IF (LLP) WRITE(IU,'(1X,A12,2I4)') 'MSLB2STDDISV5= ',IPTX,NFLEVG
    IPTX    = IPTX + NFLEVG
    IPTR2    = MAX(IPTX,IPTR2)
    MSLB2STDDISW5 = IPTX
    IF (LLP) WRITE(IU,'(1X,A12,2I4)') 'MSLB2STDDISW5= ',IPTX,NFLEVG
    IPTX    = IPTX + NFLEVG
    IPTR2    = MAX(IPTX,IPTR2)
  ENDIF
ENDIF
...
!          MSLB1[X]9
  ...
  IF (LL2TLFF1) THEN
    ...
    IF (LRHS_CURV) THEN
      MSLB1ZR9 = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1ZR9    = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
    ENDIF
  ENDIF
  MSLB1U9  = IPTX
  ...
  IF (LRHS_CURV) THEN
    MSLB1Z9  = IPTX
    IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1Z9     = ',IPTX,ILVP2
    IPTX     = IPTX + ILVP2
  ENDIF
  MSLB1T9  = IPTX
...
!          (linear interpolations if N(X)LAG=3 or 4). 
  ...
  IF (LLSLIN_SI .AND. NTLAG>=3) THEN
    ...
    IPTX     = IPTX + ILVP2
  ENDIF
  IF (YDDYNA%LNHDYN .AND. LLSLIN_SI .AND. NSVDLAG>=3) THEN
    MSLB1VD9_SI = IPTX
    IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1VD9_SI = ',IPTX,ILVP2
    IPTX     = IPTX + ILVP2
  ENDIF
  IF (YDDYNA%LNHEE .AND. LLSLIN_SI .AND. NSPDLAG==3) THEN
    MSLB1PD9_SI = IPTX
...
!          (linear interpolations if N(X)LAG=3 or 4). 
  ...
  IF (LLSETTLS .AND. NTLAG==3) THEN
    ...
    IPTX     = IPTX + ILVP2
  ENDIF
  IF (YDDYNA%LNHDYN .AND. LLSETTLS .AND. NSVDLAG==3) THEN
    MSLB1VD9_NL = IPTX
    IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1VD9_NL = ',IPTX,ILVP2
    IPTX     = IPTX + ILVP2
  ENDIF
  IF (YDDYNA%LNHEE .AND. LLSETTLS .AND. NSPDLAG==3) THEN
    MSLB1PD9_NL = IPTX
...
!          MSLB1[X]0 and MSLB1C9
  ...
  IF (NWLAG >= 3) THEN
    ...
    IF (LRHS_CURV) THEN
      MSLB1Z0  = IPTX
      IF (LLP)WRITE(IU,'(1X,A14,2I4)') 'MSLB1Z0     = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
    ENDIF
  ENDIF
  IF (NTLAG >= 3) THEN
  ...
  IF (LLSLAD) THEN
    ...
    IPTX     = IPTX + ILVP2
  ENDIF
  IF (YDDYNA%LNHDYN.AND.(NSVDLAG >= 3)) THEN
    MSLB1VD0  = IPTX
    IF (LLP)WRITE(IU,'(1X,A14,2I4)') 'MSLB1VD0    = ',IPTX,ILVP2
    IPTX     = IPTX + ILVP2
  ENDIF
  IF (YDDYNA%LNHEE.AND.(NSPDLAG == 3)) THEN
    MSLB1PD0  = IPTX
...
!          MSLB1[X]P9
  ...
  IF( LSLPHY ) THEN
    ...
    IF (LRHS_CURV) THEN
      MSLB1ZP9  = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1ZP9     = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
    ENDIF
    MSLB1TP9  = IPTX
    IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1TP9     = ',IPTX,ILVP2
    IPTX     = IPTX + ILVP2
    ! IF (YSPPT_CONFIG%LSPSDT.AND.(.NOT.YSPPT_CONFIG%LRADCLR_SDT)) THEN
    MSLB1SPPTCLEARP9  = IPTX
    IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1SPPTCLEARP9     = ',IPTX,ILVP2
    IPTX     = IPTX + ILVP2
    ! ENDIF
    MSLB1GFLP9 = IPTX
    IF (LLP) WRITE(IU,'(1X,A14,3I4)') 'MSLB1GFLP9   = ',IPTX,ILVP2*INUMGFL_SLP
    IPTX = IPTX + ILVP2*INUMGFL_SLP
  ENDIF
...
!          MSLB1[X]95 and MSLB1[X]05
  ...
  IF (LLSLAD) THEN
    ...
    IF (LRHS_CURV) THEN
      MSLB1Z95 = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1Z95    = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
    ENDIF
    MSLB1T95 = IPTX
    ...
    IF (LRHS_CURV) THEN
      MSLB1Z05 = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1Z05    = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
    ENDIF
    MSLB1T05 = IPTX
    ...
    IF (LL2TLFF1) THEN
      ...
      IF (LRHS_CURV) THEN
        MSLB1ZR95 = IPTX
        IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1ZR95    = ',IPTX,ILVP2
        IPTX     = IPTX + ILVP2
      ENDIF
    ENDIF
    IF( LSLPHY ) THEN
      MSLB1UP95  = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1UP95    = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
      MSLB1VP95  = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1VP95    = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
      IF (LRHS_CURV) THEN
        MSLB1ZP95  = IPTX
        IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1ZP95    = ',IPTX,ILVP2
        IPTX     = IPTX + ILVP2
      ENDIF
      MSLB1TP95  = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,2I4)') 'MSLB1TP95    = ',IPTX,ILVP2
      IPTX     = IPTX + ILVP2
      MSLB1GFLP95 = IPTX
      IF (LLP) WRITE(IU,'(1X,A14,3I4)') 'MSLB1GFLP95    = ',IPTX,ILVP2*INUMGFL_SLP
      IPTX     = IPTX + ILVP2*INUMGFL_SLP
    ENDIF
  ...
  DO JF=1,ILVP2
    ...
    IF (LL2TLFF1) THEN
      IF (LRHS_CURV) THEN
        ...
        IZR9=MSLB1ZR9-1
        YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IZR9)= 1.0_JPRB
      ELSE
        IUR9=MSLB1UR9-1
        YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IUR9)=-1.0_JPRB
        IVR9=MSLB1VR9-1
    ...
    IF (LRHS_CURV) THEN
      ...
      IZ9=MSLB1Z9-1
      YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IZ9)= 1.0_JPRB
    ELSE
      IU9=MSLB1U9-1
      YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IU9)=-1.0_JPRB
      IV9=MSLB1V9-1
    ...
    IF (NWLAG >= 3) THEN
      IF (LRHS_CURV) THEN
        ...
        IZ0=MSLB1Z0-1
        YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IZ0)= 1.0_JPRB
      ELSE
        IU0=MSLB1U0-1
        YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IU0)=-1.0_JPRB
        IV0=MSLB1V0-1
    ...
    IF( LSLPHY ) THEN
      IF (LRHS_CURV) THEN
        ...
        IZP9=MSLB1ZP9-1
        YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IZP9)= 1.0_JPRB
      ELSE
        IUP9=MSLB1UP9-1
        YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+IUP9)=-1.0_JPRB
        IVP9=MSLB1VP9-1
      ...
      ! IF (YSPPT_CONFIG%LSPSDT.AND.(.NOT.YSPPT_CONFIG%LRADCLR_SDT)) THEN
      ISPPTCLEARP9=MSLB1SPPTCLEARP9-1
      YDMODEL%YRML_DYN%YRPTRSLB1%RPARSL1(JF+ISPPTCLEARP9)=1.0_JPRB
      ! ENDIF
      ! Same remark as above (see MSLB1GFLP9 setting).
      DO JGFL=1,INUMGFL_SLP
        IGFLP9=MSLB1GFLP9+(JGFL-1)*ILVP2-1
  ...
  IF (LLSLAD) THEN
    ...
    DO JF=1,ILVP2
      IF (LRHS_CURV) THEN
        ...
        IZ95=MSLB1Z95-1
        YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IZ95)= 1.0_JPRB
      ELSE
        IU95=MSLB1U95-1
        YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IU95)=-1.0_JPRB
        IV95=MSLB1V95-1
      ...
      IF (LRHS_CURV) THEN 
        ...
        IZ05=MSLB1Z05-1
        YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IZ05)= 1.0_JPRB
      ELSE
        IU05=MSLB1U05-1
        YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IU05)=-1.0_JPRB
        IV05=MSLB1V05-1
      ...
      IF (LL2TLFF1) THEN
        IF (LRHS_CURV) THEN
          ...
          IZR95=MSLB1ZR95-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IZR95)= 1.0_JPRB
        ELSE
          IUR95=MSLB1UR95-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IUR95)=-1.0_JPRB
          IVR95=MSLB1VR95-1
      ...
      IF( LSLPHY ) THEN
        IF (LRHS_CURV) THEN
          IUP95=MSLB1UP95-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IUP95)= 1.0_JPRB
          IVP95=MSLB1VP95-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IVP95)= 1.0_JPRB
          IZP95=MSLB1ZP95-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IZP95)= 1.0_JPRB
        ELSE
          IUP95=MSLB1UP95-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IUP95)=-1.0_JPRB
          IVP95=MSLB1VP95-1
        ...
        ENDIF
        ITP95=MSLB1TP95-1
        YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+ITP95)=1.0_JPRB
        DO JGFL=1,INUMGFL_SLP
          IGFLP95=MSLB1GFLP95+(JGFL-1)*ILVP2-1
          YDMODEL%YRML_DYN%YRPTRSLB15%RPARSL15(JF+IGFLP95)=1.0_JPRB
        ENDDO
      ENDIF
    ENDDO
