...
USE YOMCT0   , ONLY : NOPT_MEMORY, LECMWF
...
USE YOMTRANS , ONLY : NPROMATR, NEPROMATR, NMAX_RESOL, RDISTR_E, LMONO_TRANS, LALLOPERM, NSTACK_MEMORY_TR
USE YOMCST   , ONLY : RA
...
IF (CLMODE == 'MONO1') THEN
  ...
  CALL SETUP_TRANS0(KOUT=NULOUT,KERR=NULERR,KMAX_RESOL=NMAX_RESOL,LDALLOPERM=LALLOPERM,KOPT_MEMORY_TR=NSTACK_MEMORY_TR) 
ELSEIF (CLMODE == 'RESET' ) THEN
  ...
  CALL SETUP_TRANS0(KOUT=NULOUT,KERR=NULERR,KPRGPNS=NPRGPNS,&
   ...
   & PRAD=RA,LDALLOPERM=LALLOPERM,KOPT_MEMORY_TR=NSTACK_MEMORY_TR)
...
WRITE(NULOUT,'('' NMAX_RESOL = '', I3,'' NPROMATR = '',I4, '' NEPROMATR = '',I4, &
 & '' LALLOPERM = '',L2, '' NSTACK_MEMORY_TR = '',I2)') NMAX_RESOL,NPROMATR,NEPROMATR,LALLOPERM, NSTACK_MEMORY_TR
