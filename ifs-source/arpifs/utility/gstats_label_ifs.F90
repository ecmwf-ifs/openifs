...
CALL GSTATS_LABEL(6 ,'   ','SCAN2M - EC_PHYS')
...
CALL GSTATS_LABEL(220,'JBE','ALPHA HYBRID B - LINEAR')
CALL GSTATS_LABEL(221,'JBE','ALPHA HYBRID B - ADJOINT')
CALL GSTATS_LABEL(222,'JBE','ALPHA HYBRID B - SUINEP')
CALL GSTATS_LABEL(223,'JBE','ALPHA HYBRID B - SUINEP READING')
CALL GSTATS_LABEL(224,'JBE','ALPHA HYBRID B - SUINEP INTERPOLATING')
CALL GSTATS_LABEL(225,'JBE','ALPHA HYBRID B - SUINEP STORE')
CALL GSTATS_LABEL(230,'JBA','FIELD_CONTAINER_READ_FILE')
CALL GSTATS_LABEL(231,'JBA','FIELD_CONTAINER_WRITE_FILE')
...
CALL GSTATS_LABEL(1334,'OMP','SCAN2M COBS ECV')
