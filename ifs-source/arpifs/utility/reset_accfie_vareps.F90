...
ASSOCIATE(NPROMA=>YDDIM%NPROMA, &
 & NGPTOT=>YDGEM%NGPTOT, &
 & RDAY=>YDCST%RDAY, REA=>YDCST%REA, REPSM=>YDCST%REPSM, RCPV=>YDCST%RCPV, &
 & RETV=>YDCST%RETV, RCW=>YDCST%RCW, RCS=>YDCST%RCS, RLVTT=>YDCST%RLVTT, RLSTT=>YDCST%RLSTT, &
 ...
 & RBETD=>YDCST%RBETD, RGAMD=>YDCST%RGAMD, RG=>YDCST%RG, RV=>YDCST%RV, &
