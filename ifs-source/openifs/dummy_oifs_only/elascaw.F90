...
SUBROUTINE ELASCAW(&
 & YDVSPLIP,LDSLHDHEAT,YDSL,LDREGETA,YDDYNA,KPROMB,KDIMK,KST,KPROF,KFLEV,&
...
REAL(KIND=JPRB) ,INTENT(OUT) :: PVINTWSLVF(KPROMB,KFLEV,3)
...
call abor1("ELASCAW should never be called with this build configuration - EXITING")
