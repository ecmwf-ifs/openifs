...
SUBROUTINE ETRANSINV_MDL(YDGEOMETRY,YDGMV,YDMDDH,YDML_GCONF,YDDYNA,PSPVOR,PSPDIV,PSPMEANU,PSPMEANV,PSPSP,PSPHV,PSPGFL,&
...
call abor1("ETRANSINV_MDL should never be called with this build configuration - EXITING")
