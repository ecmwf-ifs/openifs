...
SUBROUTINE ETRANSINVH(YDGEOMETRY,YDGFL,YDGMV,YDML_DIAG,YDML_GCONF,YDDYNA,CDCONF,YDSP,YDMTRAJ)
...
call abor1("ETRANSINVH should never be called with this build configuration - EXITING")
