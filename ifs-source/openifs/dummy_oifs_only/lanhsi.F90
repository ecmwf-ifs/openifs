...
SUBROUTINE LANHSI(YDGEOMETRY,YDGMV,YDGFL,YDDYN,YDDYNA,KST,KPROF,LDGWADV,PRCORI,PREDIV,PGMV,PGMVS,PGFL,&
...
call abor1("LANHSI should never be called with this build configuration - EXITING")
