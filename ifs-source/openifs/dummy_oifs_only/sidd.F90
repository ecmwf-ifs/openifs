...
SUBROUTINE SIDD(YDGEOMETRY,YDDYN,YDDYNA,KLEV,KLON,PDH,PDV,PRNH,PT,PSP,KNLON)
...
call abor1("SIDD should never be called with this build configuration - EXITING")
END SUBROUTINE SIDD
