...
SUBROUTINE SPNHQESI(&
 & YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDDYNA,KM,KMLOC,KSTA,KEND,LDONEM,LDDO_PARTSI,&
...
call abor1("SPNHQESI should never be called with this build configuration - EXITING")
